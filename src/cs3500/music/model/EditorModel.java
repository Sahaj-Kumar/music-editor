 ...
 * Functionality incluses adding and removing notes, and adjusting current notes'
 * start point, length, and pitch. Has other componenets such as tempo and
 * beats per measure. Notes cannot overlap in the model.
 */
public class EditorModel implements MusicEditorModel {
  ...
  /**
   * Retrieves the particular note from list of pitches. If note does not exist,
   * just returns null;
   * @param note note being searched for
   * @param notes notes from which to search in
   * @return note of given pitch, null if it does not exist
   */
